...
import time
from locators import USER_NAME_FIELD, PASSWORD_FIELD, LOGIN_BUTTON
...
def test_login_form(driver):
    ...
    # вводим валидный логин в none "Username"
    driver.find_element(By.XPATH, USER_NAME_FIELD).send_keys(LOGIN)
